      ...
      <b-list-group class="list-group-accent">
        ...
        <b-list-group-item href="#" class="list-group-item-accent-warning list-group-item-divider">
          ...
          <small class="text-muted mr-3">
            <em class="icon-calendar"></em>&nbsp;&nbsp;1 - 3pm
          </small>
          <small class="text-muted">
            <em class="icon-location-pin"></em>&nbsp;&nbsp;Palo Alto, CA
          </small>
        </b-list-group-item>
        <b-list-group-item href="#" class="list-group-item-accent-info">
          ...
          <small class="text-muted mr-3"><em class="icon-calendar"></em>&nbsp;&nbsp;4 - 5pm</small>
          <small class="text-muted"><em class="icon-social-skype"></em>&nbsp;&nbsp;On-line</small>
        </b-list-group-item>
        ...
        <b-list-group-item href="#" class="list-group-item-accent-danger list-group-item-divider">
          ...
          <small class="text-muted mr-3"><em class="icon-calendar"></em>&nbsp;&nbsp;10 - 11pm</small>
          <small class="text-muted"><em class="icon-home"></em>&nbsp;&nbsp;creativeLabs HQ</small>
        ...
        <b-list-group-item href="#" class="list-group-item-accent-success list-group-item-divider">
          ...
          <small class="text-muted mr-3"><em class="icon-calendar"></em>&nbsp; 1 - 3pm</small>
          <small class="text-muted"><em class="icon-location-pin"></em>&nbsp; Palo Alto, CA</small>
        </b-list-group-item>
        <b-list-group-item href="#" class="list-group-item-accent-primary list-group-item-divider">
          <div><strong>Team meeting</strong></div>
          <small class="text-muted mr-3"><em class="icon-calendar"></em>&nbsp; 4 - 6pm</small>
          <small class="text-muted"><em class="icon-home"></em>&nbsp; creativeLabs HQ</small>
          <div class="avatars-stack mt-2">
            <div class="avatar avatar-xs">
      ...
      <div class="p-3">
        ...
        <div class="aside-options">
          <div class="clearfix mt-4">
            <small><strong>Option 1</strong></small>
        ...
        <div class="aside-options">
          <div class="clearfix mt-3">
            <small><strong>Option 2</strong></small>
        ...
        <div class="aside-options">
          <div class="clearfix mt-3">
            <small><strong>Option 3</strong></small>
        ...
        <div class="aside-options">
          <div class="clearfix mt-3">
            <small><strong>Option 4</strong></small>
            <c-switch color="success" label variant="pill" size="sm" class="float-right" checked />
          </div>
        </div>
        <hr>
